...
my $backend  = $ENV{UPSTREAM_BACKEND} || 'http://web-backend:80';
...
sub trigger_ami_originate {
	...
	# This kicks off the dialplan execution asynchronously so busy signal from gate won't cause AMI error
...
my $inner_app = sub {
	...
	# Serve local authentication forms and public static assets
